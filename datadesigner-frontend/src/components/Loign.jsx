        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              ...
              <span className="text-blue-600 hover:text-blue-800 cursor-pointer font-medium transition-colors cursor-pointer">
                Sign up
              </span>
            </p>
          </div>
        ...
        <div className="hidden md:block md:w-1/2 bg-gradient-to-br from-blue-500 to-cyan-400 relative overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center p-12">
            <div className="text-white text-center">
              ...
              <button className="px-6 py-2 border-2 border-white rounded-full text-white font-medium hover:bg-white hover:text-blue-600 transition-colors cursor-pointer">
                Sign Up
              </button>
            </div>
          </div>
